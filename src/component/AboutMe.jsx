...
const AboutMe = () => {
  return (
    <section
      className="min-h-[70vh] flex items-center justify-center p-8 md:p-12 lg:p-16"
      id="about"
    >
      <div
        className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full"
        data-purpose="about-me-container"
      >
        ...
        <div className="lg:col-span-5 flex" data-purpose="services-timeline">
          ...
          <div className="space-y-16">
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white/90 group-hover:text-white transition-colors duration-300">
        ...
        <div
          className="lg:col-span-7 space-y-10 mt-12 lg:mt-0"
          data-purpose="about-biography"
        >
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6">
            About me
          </h1>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-2xl">
            My web development journey is fueled by a passion for building
            interactive and user-friendly digital experiences. Since 2022, I
            have been deeply immersed in modern frameworks, mastering
            technologies like React, Next.js, Express.js, and Node.js to build
            robust, scalable, and high-performance applications that solve
            real-world problems.
          </p>
